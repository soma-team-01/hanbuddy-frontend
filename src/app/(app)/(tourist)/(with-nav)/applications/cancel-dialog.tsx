...
export function CancelDialog({ onClose }: Readonly<{ onClose: () => void }>) {
  ...
  return (
    <div
      className="fixed inset-0 z-20 flex items-center justify-center bg-black/30 px-4 backdrop-blur-[2px]"
      role="dialog"
      aria-modal="true"
      aria-labelledby="cancel-dialog-title"
    >
      <div className="w-full rounded-3xl bg-cream p-6 shadow-xl">
