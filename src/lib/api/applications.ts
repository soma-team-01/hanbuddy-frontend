...
): Promise<CancellationQuoteResult> {
  return requestApiResult<CancellationQuoteResponse, "quote">(
    `/api/applications/me/${applicationId}/cancellation-quote`,
    "quote",
    undefined,
    DEFAULT_CANCELLATION_QUOTE_ERROR_MESSAGE,
  );
}
